...
import com.example.hotelmangementproject.databinding.FragSmHistoryBinding;

public class HistoryFragment extends Fragment {
    private FragSmHistoryBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragSmHistoryBinding.inflate(inflater, container, false);
